...
var CheckButton = function (_Component) {
    ...
    function CheckButton(props) {
        ...
        _this.svgBackgroundState = _this.svgBackgroundState.bind(_this);
    ...
    _createClass(CheckButton, [{
        ...
        value: function svgBackgroundState() {
            if (this.props.isSelected) return "block";
            return "none";
        }
    }, {
        key: "visibility",
        value: function visibility() {
            if (this.props.isSelected || this.props.parentHover) return 'visible';
            return 'hidden';
        }
    }, {
        key: "onMouseOver",
...
CheckButton.propTypes = { index: _react.PropTypes.number,
    ...
    parentHover: _react.PropTypes.string,
