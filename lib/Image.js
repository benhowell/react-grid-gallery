...
var Image = function (_Component) {
    ...
    _createClass(Image, [{
        ...
        value: function tileOverlayBackground() {
            if (this.state.hover && !this.props.isSelected) return 'linear-gradient(to bottom,rgba(0,0,0,0.26),transparent 56px,transparent)';
            return 'none';
        }
    }, {
        ...
        value: function renderCheckButton() {
            if (this.props.isSelectable) return _react2.default.createElement(_CheckButton2.default, { key: 'Select',
...
Image.propTypes = { item: _react.PropTypes.object,
    ...
    onToggleSelected: _react.PropTypes.func };
