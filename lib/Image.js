...
var Image = function (_Component) {
    ...
    function Image(props) {
        ...
        _this.style = {
            tileInner: {
                width: "" + _this.props.item.vwidth + "px",
                height: _this.props.height,
                overflow: "hidden"
            },
            tileInnerSelected: {
                width: "" + _this.props.item.vwidth - 32 + "px",
            ...
            thumbnail: {
                cursor: 'pointer',
                width: "" + _this.props.item.scaletwidth + "px",
                height: _this.props.height,
                marginLeft: "" + (_this.props.item.vx ? -_this.props.item.vx : 0) + "px",
                marginTop: "" + 0 + "px"
            },
            thumbnailSelected: {
                cursor: 'pointer',
                width: "" + _this.props.item.scaletwidth - 32 + "px",
                height: _this.props.height - 32,
                marginLeft: "" + (_this.props.item.vx ? -_this.props.item.vx : 0) + "px",
                marginTop: "" + 0 + "px"
            }
    ...
    _createClass(Image, [{
        ...
        key: 'tileInnerStyle',
        value: function tileInnerStyle() {
            if (this.state.isSelected) return this.style.tileInnerSelected;
            return this.style.tileInner;
        }
    }, {
        key: 'thumbnailStyle',
        value: function thumbnailStyle() {
            if (this.state.isSelected) return this.style.thumbnailSelected;
